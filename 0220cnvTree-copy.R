...
#####original extdata#####
  ...
  # Input (Example by demodata)
    ...
    example_data <- readRDS(system.file("extdata", "example_data.rds", package = "cnvTree"))
    write.table(example_data, file = "example_data.txt", sep = "\t", row.names = FALSE, quote = FALSE)
